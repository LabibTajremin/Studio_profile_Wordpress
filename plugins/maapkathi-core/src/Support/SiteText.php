		...
		return array(
			'Home'     => array(
				array(
					...
					'label' => __( 'Hero eyebrow', 'maapkathi' ),
				),
				array(
					'key'   => 'home_tagline_note',
					'label' => __( 'Tagline note', 'maapkathi' ),
				),
				array(
					'key'   => 'home_clients_heading',
				...
				array(
					...
					'label' => __( 'Services heading', 'maapkathi' ),
				),
				array(
					'key'   => 'home_stats_heading',
				...
				array(
					...
					'label' => __( 'Awards heading', 'maapkathi' ),
				),
				array(
				...
				array(
					'key'   => 'home_cta_button_label',
					'label' => __( 'Closing CTA button label', 'maapkathi' ),
				),
			),
			'Work'     => array(
				array(
					'key'   => 'work_archive_heading',
					'label' => __( 'Work archive heading', 'maapkathi' ),
				),
				array(
					'key'   => 'work_empty_state',
					'label' => __( 'Empty-state message', 'maapkathi' ),
				),
			),
			'Services' => array(
				array(
					'key'   => 'services_heading',
					'label' => __( 'Services page heading', 'maapkathi' ),
				),
				array(
					'key'   => 'services_intro',
					'label' => __( 'Services page intro', 'maapkathi' ),
				),
			),
			'About'    => array(
				array(
					'key'   => 'about_heading',
					'label' => __( 'About heading', 'maapkathi' ),
				),
				array(
					'key'   => 'about_intro',
					'label' => __( 'About intro', 'maapkathi' ),
				),
				array(
					'key'   => 'about_vision_heading',
					'label' => __( 'Vision heading', 'maapkathi' ),
				),
				array(
					'key'   => 'about_mission_heading',
					'label' => __( 'Mission heading', 'maapkathi' ),
				),
			),
			'Team'     => array(
				array(
					'key'   => 'team_heading',
					'label' => __( 'Team page heading', 'maapkathi' ),
				),
				array(
					'key'   => 'team_intro',
					'label' => __( 'Team page intro', 'maapkathi' ),
				),
			),
			'Contact'  => array(
				array(
					'key'   => 'contact_heading',
					'label' => __( 'Contact heading', 'maapkathi' ),
				),
				array(
					'key'   => 'contact_intro',
					'label' => __( 'Contact intro', 'maapkathi' ),
				),
				array(
					'key'   => 'contact_form_button_label',
					'label' => __( 'Form submit button label', 'maapkathi' ),
				),
				array(
					'key'   => 'contact_success_message',
					'label' => __( 'Success message', 'maapkathi' ),
				),
			),
			'Footer'   => array(
				array(
